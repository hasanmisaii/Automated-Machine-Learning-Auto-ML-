...
automl_run_id = 'hungry_brick_2qm1mn8t1f_338'
...
def generate_data_transformation_config():
    ...
    column_group_0 = [['X_Minimum'], ['X_Maximum'], ['Y_Minimum'], ['Y_Maximum'], ['Pixels_Areas'], ['X_Perimeter'], ['Y_Perimeter'], ['Sum_of_Luminosity'], ['Minimum_of_Luminosity'], ['Maximum_of_Luminosity'], ['Length_of_Conveyer'], ['Edges_Index'], ['Empty_Index'], ['Square_Index'], ['Outside_X_Index'], ['Edges_X_Index'], ['Edges_Y_Index'], ['Outside_Global_Index'], ['LogOfAreas'], ['Log_X_Index'], ['Log_Y_Index'], ['Orientation_Index'], ['Luminosity_Index'], ['SigmoidOfAreas']]
    
    column_group_1 = ['TypeOfSteel_A300', 'TypeOfSteel_A400']
    
    column_group_2 = ['Steel_Plate_Thickness']
...
def generate_algorithm_config():
    ...
    algorithm = PreFittedSoftVotingClassifier(
        ...
        weights=[0.13333333333333333, 0.13333333333333333, 0.26666666666666666, 0.06666666666666667, 0.06666666666666667, 0.13333333333333333, 0.06666666666666667, 0.06666666666666667, 0.06666666666666667]
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://locations/switzerlandnorth/workspaces/36865145-68b7-432a-bb29-1474f367d774/data/SteelPlateDataset_/versions/1',     help='Default training dataset uri is populated from the parent run')
